    ...
    <div className="w-full min-h-1/2 flex flex-col bg-white p-4 sm:p-5 rounded-2xl">
      ...
      <div className="space-y-3 sm:space-y-4">
        <div className="p-3 sm:p-4 border rounded-lg">
          <h3 className="text-lg sm:text-xl font-bold mb-2">Change Password</h3>
        ...
        <div className="p-3 sm:p-4 border rounded-lg">
          <h3 className="text-lg sm:text-xl font-bold mb-2">Notification</h3>
          <div className="flex items-center">
            <input type="checkbox" id="emailNotif" className="mr-2" />
            <label htmlFor="emailNotif" className="text-sm sm:text-base">Receive email notifications</label>
          </div>
        </div>

        <div className="p-3 sm:p-4 border rounded-lg">
          <h3 className="text-lg sm:text-xl font-bold mb-2">Language</h3>
